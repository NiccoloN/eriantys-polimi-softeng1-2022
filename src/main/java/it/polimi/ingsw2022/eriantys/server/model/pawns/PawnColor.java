...
public enum PawnColor implements Serializable {
    ...
    RED(AnsiCodes.RED, AnsiCodes.RED_BACKGROUND), GREEN(AnsiCodes.GREEN_BRIGHT, AnsiCodes.GREEN_BACKGROUND_BRIGHT), YELLOW(AnsiCodes.YELLOW, AnsiCodes.YELLOW_BACKGROUND), BLUE(AnsiCodes.BLUE_BRIGHT, AnsiCodes.BLUE_BACKGROUND_BRIGHT), PINK(AnsiCodes.PURPLE_BRIGHT, AnsiCodes.PURPLE_BACKGROUND_BRIGHT);
