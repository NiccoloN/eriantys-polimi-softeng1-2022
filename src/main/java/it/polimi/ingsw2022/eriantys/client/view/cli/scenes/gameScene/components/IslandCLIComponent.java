...
public class IslandCLIComponent extends BasicCLIComponent {
    ...
    /**
     * @return the compound index of this island component
     */
    ...
    public void setCompoundIndex(int compoundIndex) {
        ...
        if (compoundIndex < 0 || compoundIndex > 11)
            throw new InvalidParameterException("Index must be between 0 and 11");
    ...
    /**
     * @return whether mother nature is visible on this island component
     */
