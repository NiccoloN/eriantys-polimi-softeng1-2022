...
public class AnsiColorCodes {
    ...
    public static final String BLACK_UNDERLINED_BRIGHT = "\u001B[4;90m";
    public static final String RED_UNDERLINED_BRIGHT = "\u001B[4;91m";
    public static final String GREEN_UNDERLINED_BRIGHT = "\u001B[4;92m";
    public static final String YELLOW_UNDERLINED_BRIGHT = "\u001B[4;93m";
    public static final String BLUE_UNDERLINED_BRIGHT = "\u001B[4;94m";
    public static final String PURPLE_UNDERLINED_BRIGHT = "\u001B[4;95m";
    public static final String CYAN_UNDERLINED_BRIGHT = "\u001B[4;96m";
    public static final String WHITE_UNDERLINED_BRIGHT = "\u001B[4;97m";
